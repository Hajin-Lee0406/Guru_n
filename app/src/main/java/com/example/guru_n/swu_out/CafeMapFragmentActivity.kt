...
//import com.example.guru_n.CafetResult1Activity
...
import com.example.guru_n.swu_out.result.cafe.CafeResult2Activity
import com.example.guru_n.swu_out.result.cafe.CafeResult3Activity
...
class CafeMapFragmentActivity : Activity(), OnMapReadyCallback {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        CafebtnList1.setOnClickListener {
            var intent = Intent(this, CafeResult1Activity::class.java)
